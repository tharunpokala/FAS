...
window.configure(background='#33ADFF')
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System" ,bg="white"  ,fg="black"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 

message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter ID",width=20  ,height=1  ,fg="red"  ,bg="yellow" ,font=('times', 15, ' bold ') ) 
lbl.place(x=400, y=200)

txt = tk.Entry(window,width=20  ,bg="yellow" ,fg="red",font=('times', 15, ' bold '))
txt.place(x=700, y=200)

lbl2 = tk.Label(window, text="Enter Name",width=20  ,fg="red"  ,bg="yellow"    ,height=1 ,font=('times', 15, ' bold ')) 
lbl2.place(x=400, y=250)

txt2 = tk.Entry(window,width=20  ,bg="yellow"  ,fg="red",font=('times', 15, ' bold ')  )
txt2.place(x=700, y=250)

lbl5 = tk.Label(window, text="Enter Mail",width=20  ,fg="red"  ,bg="yellow"    ,height=1 ,font=('times', 15, ' bold ')) 
lbl5.place(x=400, y=300)
...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="yellow",activeforeground = "green",width=30  ,font=('times', 15, ' bold ')) 
...
def TakeImages():        
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        cam = cv2.VideoCapture(0)#'s_train.mp4'
...
def TrackImages():
    ...
    cam = cv2.VideoCapture(0)#'gr_test3.mp4'
...
trackImg = tk.Button(window, text="Take Attendance", command=TrackImages  ,fg="red"  ,bg="yellow"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
...
copyWrite.insert("insert", "Developed by batch 6","", "TEAM", "superscript")
